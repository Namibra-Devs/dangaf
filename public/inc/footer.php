        ...
        <div class="d-lg-flex justify-content-around align-items-start">
            <div class="about col-lg-5">
                ...
                <p class="">
                    ...
                    <?php
                    $footerAbout = strip_tags($fetchAbout[0]['footer_about']);
                    echo $footerAbout;
                    ?>
                </p>
                <div>
                    <p class="tel"><?php echo $fetchAbout[0]['contact_phone'] ?> </p>
                    <p class=""><?php echo $fetchAbout[0]['contact_email'] ?> </p>
                </div>
            </div>
            ...
            <div class="socials mt-lg-0 mt-5 col-lg-2">
                <ul class="d-flex p-lg-2 p-0 list-none">
                    <li class="mx-lg-3">
                        <a href="<?php echo $fetchSocial[15]['social_url'] ?>" class="text-light">
                    ...
                    <li class="mx-3">
                        <a href="<?php echo $fetchSocial[14]['social_url'] ?>" class="text-light">
                    ...
                    <li class="mx-3">
                        <a href="<?php echo $fetchSocial[13]['social_url'] ?>" class="text-light">
                    ...
                    <li class="mx-3">
                        <a href="<?php echo $fetchSocial[9]['social_url'] ?>" class="text-light">
