                                ...
                                <div class="col-lg-4 col-8">
                                    <div class="card border-0">
                                        <div class="card-body border border-1 border-warning px-4 py-5 w-100">
                                            <img src="./public/asserts/images/profiles/profile2.svg" alt="" class="image-fluid mb-4 border-2 border-secondary rounded-5">
                                            <p>Use audio to have live conversations with other collaborators directly in your Figma and
                                                FigJam files. Use audio to have live conversations with other collaborators directly in your
                                                Figma and FigJam files.</p>

                                            <h5 class="fs-5 fw-bold ff-header mt-3">Standard Telecoms</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-8 d-lg-block d-none">
                                    <div class="card border-0">
                                        <div class="card-body border border-1 border-warning px-4 py-5 w-100">
                                            <img src="./public/asserts/images/profiles/profile3.svg" alt="" class="image-fluid mb-4 border-2 border-secondary rounded-5">
                                            <p>Use audio to have live conversations with other collaborators directly in your Figma and
                                                FigJam files. Use audio to have live conversations with other collaborators directly in your
                                                Figma and FigJam files.</p>
