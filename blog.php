...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@300;500;700&family=Inter:wght@300&family=Plus+Jakarta+Sans:wght@300;600;700&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
        ...
        <div class="d-flex justify-content-between w-100">
          <div class="logo">
            <a class="navbar-brand" href="./index.php">
              <img
                src="./public/asserts/images/logo.svg"
                alt=""
                class="image-fluid logo"
              />
            </a>
          </div>
    ...
    <main>
      <!-- Header -->
      <div
        class="card border-0 text-white bg-responsive w-100"
        style="height: 5rem"
      >
        <img
          src="./public/asserts/images/headerbg.svg"
          class="card-img w-100 d-none d-md-block"
          alt="building"
          style="height: 14rem"
        />
        <img
          src="./public/asserts/images/headerbg1.svg"
          class="card-img w-100 d-md-none d-block"
          alt="building"
        />
        <div class="card-img-overlay mt-md-2 mt-5 text-center">
          <div
            class="container center mt-5 justify-content-center align-items-center"
          >
            <div class="overlay-text justify-content-center align-items-center">
              <div class="headers text-center">
                <svg
                  class="ml d-lg-inline d-none"
                  width="140"
                  height="60"
                  viewBox="0 0 296 80"
                  fill="none"
                ...
                >
                  <path
                    d="M296 47H0V113H296V47Z"
                    fill="#E48415"
                    mask="url(#path-1-inside-1_1966_5637)"
                  />
                </svg>
                <svg
                  class="ml d-lg-none d-inline"
                  width="120"
                  height="60"
                  viewBox="0 0 296 80"
                  fill="none"
      ...
      <div class="blog">
        <div class="container p-5">
          <div
            class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-4"
          >
            <div
              class="card col-lg-3 col-md-4 justify-content-center align-items-center"
            >
              <img
                src="./public/asserts/images/building/workers.webp"
                class="card-img-top image-fluid w-100"
                alt="..."
              />
              <div class="card-body border-0">
                ...
                <a href="./blogread.php" class="btn">Read More</a>
              </div>
            </div>
            ...
            >
              <img
                src="./public/asserts/images/building/foundation.webp"
                class="card-img-top image-fluid w-100"
                alt="..."
              />
              <div class="card-body">
            ...
            >
              <img
                src="./public/asserts/images/building/foundation3.webp"
                class="card-img-top image-fluid w-100"
                alt="..."
              />
              <div class="card-body">
        ...
        <div class="d-lg-flex justify-content-around align-items-start">
          <div class="about col-lg-5">
            <a href="" class="fs-5 fw-bold text-light">
              <img
                src="./public/asserts/images/logo_light.svg"
                alt=""
                class="image-fluid logo-light"
              />
            </a>
            <p class="">
